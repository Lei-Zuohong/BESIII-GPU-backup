...
/**
	...
	**/
class GPUOrbitalTensors : public GPUDataDependentObject
{
public:
	...
	**/
	...
	//GPUOrbitalTensors(GPUDataDependentObjectList * _list, GPUStreamVector & _pa, GPUStreamVector & _pb, GPUStreamVector & _pc, float _r = 0.6f);
	//	GPUOrbitalTensors(GPUDataDependentObjectList * _list, GPUStreamVector & _pa, GPUStreamVector & _pb, GPUStreamVector & _pc, float _r = 1.0f);
	...
	**/
	...
	//	GPUOrbitalTensors(GPUDataDependentObjectList * _list, GPUConstVector & _pa, GPUStreamVector & _pb, GPUStreamVector & _pc, float _r = 0.6f);
	//	GPUOrbitalTensors(GPUDataDependentObjectList * _list, GPUConstVector & _pa, GPUStreamVector & _pb, GPUStreamVector & _pc, float _r = 1.0f);
	...
	**/
	...
	//	GPUOrbitalTensors(GPUDataDependentObjectList * _list, float4 & _pa, GPUStreamVector & _pb, GPUStreamVector & _pc, float _r = 0.6f);
	//	GPUOrbitalTensors(GPUDataDependentObjectList * _list, float4 & _pa, GPUStreamVector & _pb, GPUStreamVector & _pc, float _r = 1.0f);
