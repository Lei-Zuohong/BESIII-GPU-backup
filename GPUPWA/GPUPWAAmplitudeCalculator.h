 ...
 *
 */
class GPUPWAAmplitudeCalculator : public GPUPWACalculator
{
public:
	...
	virtual void GetAmplitudes_Data(const vector<double> &pars, char *filename);
	//virtual void GetAmplitudes_MC(const vector<double> &pars, char *filename);
...
protected:
	...
	GPULookupTable *mLookupTable_data;
	GPULookupTable *mLookupTable_mc;
	int mNCoefficient_data;
	int mNCoefficient_mc;
	int mNAddition_data;
	int mNAddition_mc;
