...
/* zhangyt */
__kernel void kerneltensorcontract_f4444_2(float44  input1, __global float44 * input2,  __global out float * output)
{
	 uint i = get_global_id(0);
	float44 m;
	m.c = input1.c*input2[i].c;
	m.d = input1.d*input2[i].d;
	m.e = input1.e*input2[i].e;
	m.f = input1.f*input2[i].f;
	output[i] = m.c.x+m.c.y+m.c.z-m.c.w +
			 m.d.x+m.d.y+m.d.z-m.d.w +
			 m.e.x+m.e.y+m.e.z-m.e.w -
			 m.f.x-m.f.y-m.f.z+m.f.w;
