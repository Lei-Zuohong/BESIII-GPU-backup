...
GPUPropagatorGS::GPUPropagatorGS(char * name,GPUStreamScalar & _mx2, float _m_1, float _m_2, float _r, int _l):
		GPUBasicPropagator(name, _mx2, std::vector<char**>(2,(char **)0), 2),m1_2(_m_1*_m_1),m2_2(_m_2*_m_2),m_r(_r),m_l(_l)
{
